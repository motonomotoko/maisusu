...
プレイヤーは、手元の材料を使って、自分の作りたいものを０から作り上げます。デジタル版のLEGOのような感覚です。

しかも作る際には部屋の広さや重力などの物理的な制約を受けることがありません。プレイヤーの思うようにものを作ることができて、創造力を育むことができるゲームです。

あるカナダの学校でマイクラを利用した授業を受けた生徒さんのインタビューでは
...
子ども達は、自分の作品や制作状況を周りに説明する中で表現力を育てることができます。

我が家でも『見て〜！』と子どもが見せにきて、分かりにくいところを質問をすれば、手を替え品を替え説明してくれます。

そうした会話や発表の機会を通して、相手へ分かりやすく伝える表現力が育ちます。

また、アイデアを形にし、理解を得るという経験を繰り返すことは、自己達成感の向上にもつながったという指摘もあります。
...
ゲーム内では特に説明もないので、自分で何を解決すべきか考え、実践しながら問題を解決していく必要があり、この過程で問題解決能力が育まれます。
...
マイクラを導入した授業では、子どもたち同士で一緒にものを作ったり、情報やスキルを共有したり、役割分担をしたりと、自然に協働姿勢が形成される様子が見られます。
...
### プロジェクトを進めるために必要な『計算力』『計画性』

マイクラをしていると計算や計画が必要な場面が繰り返し訪れます。例えば以下のような場面のように、先を見越した計算や計画ができればゲームを進める上で有利になってきます。

* 数を数えながら必要な個数分のブロックを置く。
* 素材ブロックいくつで、必要な数の道具ができるか計算して素材を集める。
...
さらに、一部の統合版や教育版マインクラフトを使えば本格的にプログラムを書いて遊ぶことも可能です。
...
ここで紹介した創造性、表現力、問題解決能力、協働性、計算力・計画性、ICTスキルは、マイクラの学びの効果として、特に多くの方が挙げられていた項目でした。
